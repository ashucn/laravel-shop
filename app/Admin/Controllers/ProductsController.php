 ...
 * 这是因为 Laravel-Admin 在创建控制器的时候默认引入了 ModelForm 这个 Trait，
 * 打开 Encore\Admin\Controllers\ModelForm 这个类可以看到里面定义了 store 方法
 *
...
class ProductsController extends Controller
{
    ...
    protected function form()
    {
        ...
        return Admin::form(Product::class, function (Form $form) {
            ...
            // 直接添加一对多的关联模型
            // 商品和商品 SKU 的关系就是一对多，第一个参数必须和主模型中定义此关联关系的方法同名
